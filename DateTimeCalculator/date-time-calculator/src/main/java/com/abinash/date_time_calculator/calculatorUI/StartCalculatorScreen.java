package com.abinash.date_time_calculator.calculatorUI;

public class StartCalculatorScreen {
	public static void printScreen() {
		System.out.println("Hi Welcome to the Calculator");
		System.out.println("Date Format: dd MM yyyy");
		System.out.println("1. Subtract between two dates and express\n   the output in days, dates, weeks, months");
